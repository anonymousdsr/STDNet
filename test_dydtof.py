...
dataset = DyDToF_Dataset(root_path="/opt/data/private/dataset/VDSRDataset/DyDToF/", train=False, txt_file="./data/dydtof_list/school_shot8.txt", scale=opt.scale, transform=data_transform)
