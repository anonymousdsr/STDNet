...
dataset = DyDToF_Dataset(root_path="./dataset/DyDToF/", train=False, txt_file="./data/dydtof_list/school_shot8_subset.txt", scale=opt.scale, transform=data_transform)
